...
````yaml api-reference/transformations/transformation.json GET /transformations
openapi: 3.1.0
info:
      ...
      parameters:
        - name: include_shared
          ...
          schema:
            type: boolean
            default: false
          description: Include shared transformations in the results
        - name: verbose
          in: query
          required: false
          schema:
            type: boolean
            default: false
          description: Include full transformation objects in the response
      responses:
        '200':
