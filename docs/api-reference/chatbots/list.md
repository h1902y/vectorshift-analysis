...
````yaml api-reference/chatbots/chatbot.json GET /chatbots
openapi: 3.1.0
info:
  title: Chatbot API
  version: 1.0.0
      ...
      parameters:
        - name: include_shared
          ...
          schema:
            type: boolean
            default: false
          description: Include shared chatbots in the results
        - name: verbose
          in: query
          schema:
            type: boolean
            default: false
          description: Include full chatbot objects in the response
      responses:
        '200':
          description: >-
            Successful response. When verbose=true, full chatbot objects are
